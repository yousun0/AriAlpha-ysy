...
window.registerModuleInit('groupmenu-setting', (element) => {
  const gs = new GroupmenuSetting(element)

});

if(isPopup) {
  new GroupmenuSetting(document.querySelector(".groupmenu-setting"));
}